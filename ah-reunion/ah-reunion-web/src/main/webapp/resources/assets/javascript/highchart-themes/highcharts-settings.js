        ...
        $(this).highcharts({
            ...
            series: [{
                ...
                data: [106, 1708, 890, 500, 490, 767, 1766],
                 ...
                 color: 'rgba(86, 161, 245, 0.5)',
                lineColor: '#56A1F5'
            }, {
                name: 'Europe',
                data: [163, 800, 276, 300, 159, 729, 628],
                color: 'rgba(134, 179, 77, 0.5)',
                lineColor: '#86B34D',
                   marker: {
                    enabled: false
                }
    ...
    Dashboard.Helpers.elementExists('.highcharts-area-with-missing-points', function() {
        $(this).highcharts({
            ...
            series: [{
                ...
                data: [0, 1, 4, 4, 5, 2, 3, 7, 8, 3, 5 ,6],
                 lineWidth: '1',
                color: 'RGBA(70, 197, 152, 1.0)',
                    fillColor: 'RGBA(70, 197, 152, 0.2)'
            }, {
                name: '2015',
                data: [8, 6, 12, 7, 3, 1, 2, 1, 9, 5, 12, 9],
                 lineWidth: '1',
                color: 'RGBA(86, 164, 243, 1.0)',
                    fillColor: 'RGBA(86, 164, 243, 0.2)'
            },  {
                name: '2016',
                data: [0, 1, 2, 1, 3, 2, 3, 2, 2, 4, 1, 3],
                 lineWidth: '1',
                color: 'RGBA(248, 93, 76, 1.00)',
                fillColor:  'RGBA(248, 93, 76, 0.2)'
        ...
        exporting: {
            ...
            series: [{
                ...
                data: [{
                    ...
                    name: 'Accounts',
                     color: 'RGBA(175, 115, 234, 1.00)',
                    y: 10.38
                   
                }, {
                    name: 'Secure Holdings',
                     color: 'RGBA(86, 161, 245, 1.00)',
                    y: 24.03
