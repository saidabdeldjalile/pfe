 ...
 */
@Embeddable
public class Trp215pPK implements Serializable {
  ...
  public Trp215pPK(int dateTrt, String numLigne) {
  ...
  public boolean equals(Object object) {
    ...
    if (!(object instanceof Trp215pPK)) {
      return false;
    }
    Trp215pPK other = (Trp215pPK) object;
  ...
  public String toString() {
    return "jpa.Trp215pPK[ dateTrt=" + dateTrt + ", numLigne=" + numLigne + " ]";
  }
