 ...
 */
@Embeddable
public class Balance312pTtPK implements Serializable {
  ...
  public Balance312pTtPK() {}

  public Balance312pTtPK(int dateTrt, String cptScf) {
  ...
  public boolean equals(Object object) {
    ...
    if (!(object instanceof Balance312pTtPK)) {
      return false;
    }
    Balance312pTtPK other = (Balance312pTtPK) object;
  ...
  public String toString() {
    return "ENTITY.Balance312pTtPK[ dateTrt=" + dateTrt + ", cptScf=" + cptScf + " ]";
  }
