 ...
 */
@Embeddable
public class GrandLivreAna300pPK implements Serializable {
  ...
  public GrandLivreAna300pPK() {}

  public GrandLivreAna300pPK(int dateTrt, String cptPart) {
  ...
  public boolean equals(Object object) {
    ...
    if (!(object instanceof GrandLivreAna300pPK)) {
      return false;
    }
    GrandLivreAna300pPK other = (GrandLivreAna300pPK) object;
  ...
  public String toString() {
    return "ENTITY.GrandLivreAna300pPK[ dateTrt=" + dateTrt + ", cptPart=" + cptPart + " ]";
  }
