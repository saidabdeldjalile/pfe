 ...
 */
@Embeddable
public class GrandLivre300pPK implements Serializable {
  ...
  public GrandLivre300pPK() {}

  public GrandLivre300pPK(int dateTrt, String cptScf, String cptPart) {
  ...
  public boolean equals(Object object) {
    ...
    if (!(object instanceof GrandLivre300pPK)) {
      return false;
    }
    GrandLivre300pPK other = (GrandLivre300pPK) object;
  ...
  public String toString() {
    return "ENTITY.GrandLivre300pPK[ dateTrt=" + dateTrt + ", cptScf=" + cptScf + ", cptPart="
        + cptPart + " ]";
  }
