 ...
 */
@Embeddable
public class BulletinDetailPK implements Serializable {
  ...
  public BulletinDetailPK() {}

  public BulletinDetailPK(int codeDtb, int matricule, int datePai, int dateTrt, boolean bulPrim,
      Character codeFil) {
  ...
  public boolean equals(Object object) {
    ...
    if (!(object instanceof BulletinDetailPK)) {
      return false;
    }
    BulletinDetailPK other = (BulletinDetailPK) object;
