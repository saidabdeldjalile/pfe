 ...
 */
@Embeddable
public class BulletinTotalPK implements Serializable {
  ...
  public BulletinTotalPK() {}

  public BulletinTotalPK(int matricule, int datePai, int dateTrt, boolean bulPrim,
      Character codeFil) {
  ...
  public boolean equals(Object object) {
    ...
    if (!(object instanceof BulletinTotalPK)) {
      return false;
    }
    BulletinTotalPK other = (BulletinTotalPK) object;
