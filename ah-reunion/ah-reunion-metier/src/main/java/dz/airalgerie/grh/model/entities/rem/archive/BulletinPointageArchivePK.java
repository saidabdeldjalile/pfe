 ...
 */
@Embeddable
public class BulletinPointageArchivePK implements Serializable {
  ...
  public BulletinPointageArchivePK() {}

  public BulletinPointageArchivePK(int matricule, int datePai, int dateTrt, boolean bulPrim,
      int codPoin, Character codeFil) {
  ...
  public boolean equals(Object object) {
    ...
    if (!(object instanceof BulletinPointageArchivePK)) {
      return false;
    }
    BulletinPointageArchivePK other = (BulletinPointageArchivePK) object;
