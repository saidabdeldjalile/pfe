 ...
 */
@Embeddable
public class BulletinArchivePK implements Serializable {
  ...
  public BulletinArchivePK() {}

  public BulletinArchivePK(int matricule, int datePai, int dateTrt, boolean bulPrim,
      Character codeFil) {
  ...
  public boolean equals(Object object) {
    ...
    if (!(object instanceof BulletinArchivePK)) {
      return false;
    }
    BulletinArchivePK other = (BulletinArchivePK) object;
  ...
  public String toString() {
    return "ENTITY.SAISIE.BulletinPK[ matricule=" + matricule + ", datePai=" + datePai
