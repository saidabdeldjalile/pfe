 ...
 */
@Embeddable
public class BulletinTotalArchivePK implements Serializable {
  ...
  public BulletinTotalArchivePK() {}

  public BulletinTotalArchivePK(int matricule, int datePai, int dateTrt, boolean bulPrim,
      Character codeFil) {
  ...
  public boolean equals(Object object) {
    ...
    if (!(object instanceof BulletinTotalArchivePK)) {
      return false;
    }
    BulletinTotalArchivePK other = (BulletinTotalArchivePK) object;
  ...
  public String toString() {
    return "ENTITY.SAISIE.BulletinTotalPK[ matricule=" + matricule + ", datePai=" + datePai
        + ", dateTrt=" + dateTrt + ", bulPrim=" + bulPrim + ", codeFil=" + codeFil + " ]";
  }
