...
public class ListeSorties {
  ...
  public ListeSorties(String typeStock, String designation, String codeATA, String specification,
      String codeMesure, String codeRepere, String codeMagasin, String pn, String codeAppareil,
      BigDecimal quantite, BigDecimal valeur, String numBon, int dateTraitSortie, Date dateSortie,
      String codeCCI, String codeAtelier, String numVisite, int typeMVT, String typeSortie) {
