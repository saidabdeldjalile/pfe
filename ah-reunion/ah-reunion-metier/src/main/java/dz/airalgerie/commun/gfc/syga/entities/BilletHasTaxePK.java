...
/**
 * The primary key class for the billet_has_taxe database table.
 * 
 */
@Embeddable
public class BilletHasTaxePK implements Serializable {
  ...
  /*
   * @Column(name="Monnaie_Code_monnaie",insertable=false,updatable=false) private String
   * monnaie_Code_monnaie;
   */
  public BilletHasTaxePK() {}
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    BilletHasTaxePK other = (BilletHasTaxePK) obj;
  ...
  // public String getMonnaie_Code_monnaie() {
  // return this.monnaie_Code_monnaie;
  // }
  // public void setMonnaie_Code_monnaie(String monnaie_Code_monnaie) {
  // this.monnaie_Code_monnaie = monnaie_Code_monnaie;
  // }
