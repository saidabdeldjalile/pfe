 ...
 */
@Embeddable
public class ArticleSortiePK implements Serializable {
  ...
  public ArticleSortiePK() {}

  public ArticleSortiePK(String pn, String codeAppareil, String numBonSortie, int dateTraitSortie) {
    this.pn = pn;
  ...
  public boolean equals(Object object) {
    ...
    if (!(object instanceof ArticleSortiePK)) {
      return false;
    }
    ArticleSortiePK other = (ArticleSortiePK) object;
  ...
  public String toString() {
    return "dz.ah.stock.dmra.entities.ArticleSortiePK[ pn=" + pn + ", codeAppareil=" + codeAppareil
