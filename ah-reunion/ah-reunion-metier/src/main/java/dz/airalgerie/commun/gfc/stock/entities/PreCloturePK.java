 ...
 */
@Embeddable
public class PreCloturePK implements Serializable {
  ...
  public PreCloturePK(String pn, String codeAppareil, int dateTraitement) {
    this.pn = pn;
  ...
  public boolean equals(Object object) {
    ...
    if (!(object instanceof PreCloturePK)) {
      return false;
    }
    PreCloturePK other = (PreCloturePK) object;
  ...
  public String toString() {
    return "dz.ah.stock.dmra.entities.PreCloturePK[ pn=" + pn + ", codeAppareil=" + codeAppareil
